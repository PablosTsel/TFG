#!/usr/bin/env python3
# Building Detection Model with Dice Loss Only
# This version uses only Dice loss to compare with the combined loss approach
...
def main():
    ...
    using only Dice loss instead of the combined BCE+Dice loss.
    """
    ...
    experiment_name = "dice_loss_only"
    ...
    # EXPERIMENT: Use only Dice loss (no BCE component)
    # This will focus more on region overlap than on per-pixel accuracy
